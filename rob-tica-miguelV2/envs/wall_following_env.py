...
class RobotActionExecutor:
    ...
    def __init__(self, robot, linear_vel_adjustment=.025, angular_vel_adjustment=.5):
    ...
    def _increase_angular_vel(self):
        ...
        self.angular_vel = min(self.angular_vel + self.angular_vel_adjustment, 3)
        cmd_vel(self.robot, self.linear_vel, self.angular_vel)

    def _decrease_angular_vel(self):
        #print('ACTION: DECREASE ANGULAR VEL')
        self.angular_vel = max(self.angular_vel - self.angular_vel_adjustment, -3)
        cmd_vel(self.robot, self.linear_vel, self.angular_vel)
...
class WallFollowingEnv(MyEnv):
    ...
    def step(self, action, end_reward=5000):
