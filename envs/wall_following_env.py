...
class RobotActionExecutor:
    ...
    def __init__(self, robot, vel_increase=.01):
        self.robot = robot
    ...
    def action_increase_linear_vel(self):
        ...
        self.linear_vel = min(self.linear_vel + self.vel_increase, 0.15)
    ...
    def action_increase_angular_vel(self):
        ...
        self.angular_vel = min(self.angular_vel + self.vel_increase, .1)
        cmd_vel(self.robot, self.linear_vel, self.angular_vel)
...
def train_model():
    ...
    try:
        ...
        model = PPO('MlpPolicy', env, verbose=1,
                    n_epochs=10, learning_rate=0.00005)
